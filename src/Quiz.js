...
/*var resultingHTML = "";
        var result = Object.keys(this.state.quiz.questions).map((value, index) => {
            this.isAnswerRight = this.isAnswerRight.bind(this);
            if (this.isAnswerRight(value)) {
                console.log("Right");
                resultingHTML += "Question " + index + ": You were right!";
            } else {
                console.log("Wrong");
                resultingHTML += "Question " + index + ": You were wrong!";
            }
            resultingHTML += " ";
        })
